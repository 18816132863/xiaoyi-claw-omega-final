...
| 类型 | 说明 | 示例 |
|------|------|------|
| 技能 | skills/ 目录下 | skills/new-skill/ |
| 模块 | 有子目录的功能模块 | orchestration/module/ |
| 文件 | 单个文件 | governance/validator.py |
| 目录 | 任意子目录 | infrastructure/tool/ |
...
```bash
# 执行融合
python infrastructure/fusion/skill_fusion_engine.py

# 查看优先级报告
python infrastructure/fusion/skill_fusion_engine.py --report
```
