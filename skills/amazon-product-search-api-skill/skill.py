#!/usr/bin/env python3
"""
amazon-product-search-api-skill 技能执行脚本
...
class AmazonProductSearchApiSkill:
    """技能主类"""
    ...
    def help(self) -> str:
        """返回帮助信息"""
        return """
amazon-product-search-api-skill 技能
...
def main():
    ...
    command = sys.argv[1]
    skill = AmazonProductSearchApiSkill()
    ...
    if command == "help":
        ...
        print("amazon-product-search-api-skill v1.0.0")
    else:
