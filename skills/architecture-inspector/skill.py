#!/usr/bin/env python3
"""
architecture-inspector 技能执行脚本
架构巡检技能，用于检查六层架构的完整性和一致性。触发词：巡检、检查架构、架构检查、inspect architecture、architecture check
"""
...
def main():
    ...
    if command == "help":
        ...
        print("architecture-inspector v1.0.0")
    else:
