#!/usr/bin/env python3
"""
bitsoul-stock-quantization 技能执行脚本
...
class BitsoulStockQuantization:
    """技能主类"""
...
def main():
    ...
    command = sys.argv[1]
    skill = BitsoulStockQuantization()
    ...
    if command == "help":
        ...
        print("bitsoul-stock-quantization v1.0.0")
    else:
