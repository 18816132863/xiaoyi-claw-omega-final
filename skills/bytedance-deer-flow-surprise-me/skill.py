#!/usr/bin/env python3
"""
bytedance-deer-flow-surprise-me 技能执行脚本
...
class BytedanceDeerFlowSurpriseMe:
    """技能主类"""
    ...
    def help(self) -> str:
        """返回帮助信息"""
        return """
bytedance-deer-flow-surprise-me 技能
...
def main():
    ...
    command = sys.argv[1]
    skill = BytedanceDeerFlowSurpriseMe()
    ...
    if command == "help":
        ...
        print("bytedance-deer-flow-surprise-me v1.0.0")
    else:
