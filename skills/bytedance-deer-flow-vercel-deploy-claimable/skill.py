#!/usr/bin/env python3
"""
bytedance-deer-flow-vercel-deploy-claimable 技能执行脚本
...
class BytedanceDeerFlowVercelDeployClaimable:
    """技能主类"""
    ...
    def help(self) -> str:
        """返回帮助信息"""
        return """
bytedance-deer-flow-vercel-deploy-claimable 技能
...
def main():
    ...
    command = sys.argv[1]
    skill = BytedanceDeerFlowVercelDeployClaimable()
    ...
    if command == "help":
        ...
        print("bytedance-deer-flow-vercel-deploy-claimable v1.0.0")
    else:
