...
"""
data-tracker 技能执行脚本
数据记录与复盘系统。记录用户指定的数据（睡眠、运动、阅读、工作等），每日自动汇总，生成复盘报告，沉淀到长期记忆。适用场景：(1) 用户想记录某项数据，(2) 每日/每周复盘，(3) 数据趋势分析，(4) 习惯养成追踪。Use when user wants to track data, record daily activities, review progress, or analyze trends.
"""
