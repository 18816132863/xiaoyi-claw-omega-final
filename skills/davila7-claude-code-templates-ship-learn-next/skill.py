#!/usr/bin/env python3
"""
davila7-claude-code-templates-ship-learn-next 技能执行脚本
...
class Davila7ClaudeCodeTemplatesShipLearnNext:
    """技能主类"""
    ...
    def help(self) -> str:
        """返回帮助信息"""
        return """
davila7-claude-code-templates-ship-learn-next 技能
...
def main():
    ...
    command = sys.argv[1]
    skill = Davila7ClaudeCodeTemplatesShipLearnNext()
    ...
    if command == "help":
        ...
        print("davila7-claude-code-templates-ship-learn-next v1.0.0")
    else:
