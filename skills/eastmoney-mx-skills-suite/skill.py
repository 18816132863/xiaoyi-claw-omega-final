#!/usr/bin/env python3
"""
eastmoney-mx-skills-suite 技能执行脚本
>
"""
...
def main():
    ...
    if command == "help":
        ...
        print("eastmoney-mx-skills-suite v1.0.0")
    else:
