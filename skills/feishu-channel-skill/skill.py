#!/usr/bin/env python3
"""
feishu-channel-skill 技能执行脚本
飞书Channel配置技能。帮助用户配置飞书机器人与OpenClaw的集成，包括创建应用、配置权限、设置事件订阅。触发词：配置飞书、飞书channel、飞书机器人、feishu配置。
"""
...
def main():
    ...
    if command == "help":
        ...
        print("feishu-channel-skill v1.0.0")
    else:
