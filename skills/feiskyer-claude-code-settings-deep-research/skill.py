#!/usr/bin/env python3
"""
feiskyer-claude-code-settings-deep-research 技能执行脚本
...
class FeiskyerClaudeCodeSettingsDeepResearch:
    """技能主类"""
    ...
    def help(self) -> str:
        """返回帮助信息"""
        return """
feiskyer-claude-code-settings-deep-research 技能
...
def main():
    ...
    command = sys.argv[1]
    skill = FeiskyerClaudeCodeSettingsDeepResearch()
    ...
    if command == "help":
        ...
        print("feiskyer-claude-code-settings-deep-research v1.0.0")
    else:
