#!/usr/bin/env python3
"""
flowchart-generator-skill 技能执行脚本
...
def main():
    ...
    if command == "help":
        ...
        print("flowchart-generator-skill v1.0.0")
    else:
