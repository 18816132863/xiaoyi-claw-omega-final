#!/usr/bin/env python3
"""
github-awesome-copilot-prd 技能执行脚本
...
def main():
    ...
    if command == "help":
        ...
        print("github-awesome-copilot-prd v1.0.0")
    else:
