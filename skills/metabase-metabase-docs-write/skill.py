#!/usr/bin/env python3
"""
metabase-metabase-docs-write 技能执行脚本
...
class MetabaseMetabaseDocsWrite:
    """技能主类"""
    ...
    def help(self) -> str:
        """返回帮助信息"""
        return """
metabase-metabase-docs-write 技能
...
def main():
    ...
    command = sys.argv[1]
    skill = MetabaseMetabaseDocsWrite()
    ...
    if command == "help":
        ...
        print("metabase-metabase-docs-write v1.0.0")
    else:
