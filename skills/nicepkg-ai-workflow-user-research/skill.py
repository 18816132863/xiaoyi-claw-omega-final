#!/usr/bin/env python3
"""
nicepkg-ai-workflow-user-research 技能执行脚本
...
class NicepkgAiWorkflowUserResearch:
    """技能主类"""
    ...
    def help(self) -> str:
        """返回帮助信息"""
        return """
nicepkg-ai-workflow-user-research 技能
...
def main():
    ...
    command = sys.argv[1]
    skill = NicepkgAiWorkflowUserResearch()
    ...
    if command == "help":
        ...
        print("nicepkg-ai-workflow-user-research v1.0.0")
    else:
