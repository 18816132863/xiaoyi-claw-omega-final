#!/usr/bin/env python3
"""
openclaw-skills-soulcraft 技能执行脚本
...
def main():
    ...
    if command == "help":
        ...
        print("openclaw-skills-soulcraft v1.0.0")
    else:
