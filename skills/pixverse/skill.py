...
"""
pixverse 技能执行脚本
PixVerse V6 视频生成模型（爱诗科技）。支持文生视频、图生视频。高质量AI视频生成，支持多种分辨率和时长。Triggers: 生成视频, AI视频, 文生视频, 图生视频, video generation, text to video, image to video, 视频创作
"""
