#!/usr/bin/env python3
"""
platform-comparison 技能执行脚本
电商平台对比分析 - 抖音/快手/小红书/视频号/淘宝直播对比，帮助选择最适合的平台。触发词：平台对比、选平台、哪个平台、平台分析。
"""
...
def main():
    ...
    if command == "help":
        ...
        print("platform-comparison v1.0.0")
    else:
