#!/usr/bin/env python3
"""
rkiding-awesome-finance-skills-alphaear-sentiment 技能执行脚本
...
class RkidingAwesomeFinanceSkillsAlphaearSentiment:
    """技能主类"""
    ...
    def help(self) -> str:
        """返回帮助信息"""
        return """
rkiding-awesome-finance-skills-alphaear-sentiment 技能
...
def main():
    ...
    command = sys.argv[1]
    skill = RkidingAwesomeFinanceSkillsAlphaearSentiment()
    ...
    if command == "help":
        ...
        print("rkiding-awesome-finance-skills-alphaear-sentiment v1.0.0")
    else:
