#!/usr/bin/env python3
"""
seedream-image_gen 技能执行脚本
基于AI的图像生成，支持文本、单图和多图输入，实现基于主体一致性的多图融合创作、图像编辑、组图生成等多样化功能。
"""
...
def main():
    ...
    if command == "help":
        ...
        print("seedream-image_gen v1.0.0")
    else:
