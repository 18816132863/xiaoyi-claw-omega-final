#!/usr/bin/env python3
"""
shareai-lab-learn-claude-code-pdf 技能执行脚本
...
class ShareaiLabLearnClaudeCodePdf:
    """技能主类"""
    ...
    def help(self) -> str:
        """返回帮助信息"""
        return """
shareai-lab-learn-claude-code-pdf 技能
...
def main():
    ...
    command = sys.argv[1]
    skill = ShareaiLabLearnClaudeCodePdf()
    ...
    if command == "help":
        ...
        print("shareai-lab-learn-claude-code-pdf v1.0.0")
    else:
