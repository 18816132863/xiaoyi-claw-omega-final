#!/usr/bin/env python3
"""
su-lan-paper-daily-skill 技能执行脚本
搜索顶会顶刊最新论文，跟踪引用数变化，总结并上传 GitHub
"""
...
def main():
    ...
    if command == "help":
        ...
        print("su-lan-paper-daily-skill v1.0.0")
    else:
