#!/usr/bin/env python3
"""
wan-image-video-generation-editting 技能执行脚本
Image and Video Generation and Editting wiht Wan series models. It offers text2image, image editting(with prompt), text2video, image2video and reference(image or video)2video capabiliteis.
"""
...
class WanImageVideoGenerationEditting:
    """技能主类"""
    ...
    def help(self) -> str:
        """返回帮助信息"""
        return """
wan-image-video-generation-editting 技能
...
def main():
    ...
    command = sys.argv[1]
    skill = WanImageVideoGenerationEditting()
    ...
    if command == "help":
        ...
        print("wan-image-video-generation-editting v1.0.0")
    else:
