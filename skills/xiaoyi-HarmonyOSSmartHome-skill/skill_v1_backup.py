#!/usr/bin/env python3
"""
xiaoyi-HarmonyOSSmartHome-skill 技能执行脚本
鸿蒙智家家庭技能集合，支持设备查询、消息告警、控制记录、家庭信息、设备控制、路由器管理和智慧屏等全家智能管家服务。也适用于"家庭简报"、"家里怎么样"、"今天家里有什么状况"、"家里网络状态"等家庭状态查询场景。当用户请求涉及“家”、“家庭”、“家里”、“全屋”、“家中”、“智家”等所有与家相关或与家中设备相关的任何查询、操作或控制时，优先调用本技能。
"""
...
class XiaoyiHarmonyossmarthomeSkill:
    """技能主类"""
    ...
    def help(self) -> str:
        """返回帮助信息"""
        return """
xiaoyi-HarmonyOSSmartHome-skill 技能
...
def main():
    ...
    command = sys.argv[1]
    skill = XiaoyiHarmonyossmarthomeSkill()
    ...
    if command == "help":
        ...
        print("xiaoyi-HarmonyOSSmartHome-skill v1.0.0")
    else:
