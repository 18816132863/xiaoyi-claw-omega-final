#!/usr/bin/env python3
"""
xiaoyi-image-search 技能执行脚本
图片搜索技能。返回图链接（OSMS预签名URL）、缩略图、图片尺寸等信息。适用于为文档、PPT、报告等场景查找配图素材。
"""
...
def main():
    ...
    if command == "help":
        ...
        print("xiaoyi-image-search v1.0.0")
    else:
