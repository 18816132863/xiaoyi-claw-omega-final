#!/usr/bin/env python3
"""
xiaoyi-image-understanding 技能执行脚本
使用小艺图像理解API进行图像内容识别和描述，获取图像的详细文本描述
"""
...
class XiaoyiImageUnderstanding:
    """技能主类"""
...
def main():
    ...
    command = sys.argv[1]
    skill = XiaoyiImageUnderstanding()
    ...
    if command == "help":
        ...
        print("xiaoyi-image-understanding v1.0.0")
    else:
