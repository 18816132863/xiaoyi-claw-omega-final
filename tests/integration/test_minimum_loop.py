...
class TestMinimumLoop(unittest.TestCase):
    ...
    def test_03_context_building(self):
        """测试上下文构建"""
    ...
    def test_04_workflow_execution(self):
        """测试工作流执行"""
        workflow_spec = {
        ...
        result = run_workflow(workflow_spec, profile="developer")
        
        self.assertEqual(result.status, WorkflowStatus.COMPLETED)
        self.assertIn("step1", result.step_results)
    
    def test_05_skill_registration_and_routing(self):
        """测试技能注册和路由"""
        # 注册技能
    ...
    def test_08_budget_management(self):
        """测试预算管理"""
        # 创建预算
    ...
    def test_09_risk_assessment(self):
        """测试风险评估"""
